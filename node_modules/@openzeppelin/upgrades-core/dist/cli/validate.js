...
async function main(args) {
    ...
    if (!help(parsedArgs, extraArgs)) {
        ...
        const result = await (0, _1.validateUpgradeSafety)(functionArgs.buildInfoDir, functionArgs.contract, functionArgs.reference, functionArgs.opts, functionArgs.referenceBuildInfoDirs);
